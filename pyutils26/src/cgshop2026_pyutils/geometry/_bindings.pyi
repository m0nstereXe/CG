...
def violates_local_delaunay(a: Point, b: Point, c: Point, d: Point) -> bool:
    """Return True if edge ab violates the empty circumcircle test with respect to points c and d."""
    ...
...
def sample_parallel_batch(
    ...
    offenders: Sequence[tuple[int, int]],
    random_pick_prob: float,
    seed: int,
) -> list[tuple[int, int]]:
    """Return a batch of non-conflicting candidate flips chosen with the annealing heuristic."""
    ...

def compute_delaunay_batches(
    points: Sequence[Point],
    edges: Sequence[tuple[int, int]],
) -> list[list[tuple[int, int]]]:
    """Return deterministic flip batches that finish a triangulation to Delaunay."""
    ...

class FlipPartnerMapNative:
    """Native flip-partner map implementation."""

    def __init__(self, points: Sequence[Point], edges: Sequence[tuple[int, int]]): ...
    ...
    def conflicting_flips(self, edge: tuple[int, int]) -> list[tuple[int, int]]: ...
    def flip(self, edge: tuple[int, int]) -> tuple[int, int]: ...
    def edges(self) -> list[tuple[int, int]]: ...
    def points(self) -> list[Point]: ...
    def deep_copy(self) -> FlipPartnerMapNative: ...
