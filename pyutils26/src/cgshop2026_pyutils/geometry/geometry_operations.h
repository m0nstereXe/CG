...
/**
 * Returns true if the diagonal (a,b) violates the local Delaunay condition with respect
 * to opposite vertices c and d (i.e., d lies inside the circumcircle of oriented triangle abc).
 */
