 ...
 *
 * @throws std::invalid_argument if constructed from a Point with non-integral
 * coordinates.
 */
class IntegralPoint {
public:
...
public:
   ...
   */
  [[nodiscard]] size_t size() const noexcept { return point_to_index_.size(); }

  /**
   * @brief Check if the map is empty.
   */
  [[nodiscard]] bool empty() const noexcept { return point_to_index_.empty(); }
